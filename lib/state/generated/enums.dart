...
enum GamePhase { LOBBY, ROLES, NIGHT_CUPID, NIGHT_LOVERS, NIGHT_WOLVES, NIGHT_WITCH, MORNING, VOTE, RESOLVE, CHECK_END, END }
...
enum Role { CUPID, HUNTER, VILLAGER, WITCH, WOLF }
